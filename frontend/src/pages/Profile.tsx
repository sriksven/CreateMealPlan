...
const Profile: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'calendars' | 'info' | 'settings'>('calendars');
      ...
      <div className="profile-container">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8 w-full mx-auto">
          <button
            ...
            style={{ color: activeTab === 'calendars' ? '#ffffff' : '#9ca3af' }}
            className={`py-3 rounded-2xl text-sm font-bold transition-all duration-300 border ${activeTab === 'calendars' ? 'bg-blue-600 border-transparent shadow-xl shadow-blue-900/20 scale-105' : 'bg-white/5 border-white/5 hover:text-white hover:bg-white/10 hover:border-white/10'}`}
          >
            Calendars
          </button>
          <button
            onClick={() => setActiveTab('info')}
            style={{ color: activeTab === 'info' ? '#ffffff' : '#9ca3af' }}
            className={`py-3 rounded-2xl text-sm font-bold transition-all duration-300 border ${activeTab === 'info' ? 'bg-blue-600 border-transparent shadow-xl shadow-blue-900/20 scale-105' : 'bg-white/5 border-white/5 hover:text-white hover:bg-white/10 hover:border-white/10'}`}
          >
            My Info & Goals
          </button>
          <button
            onClick={() => setActiveTab('settings')}
            style={{ color: activeTab === 'settings' ? '#ffffff' : '#9ca3af' }}
            className={`py-3 rounded-2xl text-sm font-bold transition-all duration-300 border ${activeTab === 'settings' ? 'bg-blue-600 border-transparent shadow-xl shadow-blue-900/20 scale-105' : 'bg-white/5 border-white/5 hover:text-white hover:bg-white/10 hover:border-white/10'}`}
          >
            Account Settings
          </button>
        </div>
        ...
        {activeTab === 'calendars' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8 animate-fade-in">
            <ProteinCalendar proteinTarget={proteinTarget} calorieTarget={calorieTarget} />
            <PantryCalendar />
          </div>
        )}

        {/* Tab Content: My Info & Goals */}
        {activeTab === 'info' && (
